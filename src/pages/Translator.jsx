      ...
      <div>
        ...
        <div className="font-roboto mt-24 flex flex-col items-center">
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <input onChange={handleChangeInputText}
                   className=" text-center border-2 border-violet-500 p-2 rounded-2xl"/>
          ...
          <div className="flex flex-row justify-center">
            <button type="button" onClick={handleTranslation}
                    className="mt-10 p-2 text-center rounded-3xl bg-violet-500 italic font-bold"> Traduire
            </button>
          </div>
          ...
          <div className="flex flex-col items-center mt-10 ">
            ...
            {translatedText ? <p className="border p-3 m-2 rounded-2xl border-violet-500">{translatedText}</p> : ''}
